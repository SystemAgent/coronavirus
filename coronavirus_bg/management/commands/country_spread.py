...
from coronavirus_bg.models import Totals
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        confirmed_df = pd.read_csv(BASE_URL + 'time_series_19-covid-Confirmed.csv')
        deaths_df = pd.read_csv(BASE_URL + 'time_series_19-covid-Deaths.csv')
        recoveries_df = pd.read_csv(BASE_URL + 'time_series_19-covid-Recovered.csv')
        ...
        for df in [confirmed_df, deaths_df, recoveries_df]:
            ...
            country_df.drop(['Province/State', 'Country/Region', 'Lat', 'Long'], axis=1, inplace=True)
